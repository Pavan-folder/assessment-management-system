"use strict";
// Assessment Management System - Sample Data
// This file contains all assessment data for the system
Object.defineProperty(exports, "__esModule", { value: true });
exports.assessmentData = void 0;
exports.getAssessmentBySessionId = getAssessmentBySessionId;
exports.getAllAssessments = getAllAssessments;
exports.getAssessmentsByType = getAssessmentsByType;
// Sample Assessment Data
exports.assessmentData = [
    ...
    // Cardiac Assessment (as_card_01)
    {
        ...
        "reportsDataId": "-OTafB4SqUgE6Y5xrqiJ",
        "timeElapsed": 67,
...
// Helper function to find assessment data by session_id
function getAssessmentBySessionId(sessionId) {
    return exports.assessmentData.find(data => data.session_id === sessionId);
}
// Helper function to get all assessment data
function getAllAssessments() {
    return exports.assessmentData;
}
// Helper function to get assessments by assessment_id
function getAssessmentsByType(assessmentId) {
    return exports.assessmentData.filter(data => data.assessment_id === assessmentId);
}
