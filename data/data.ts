...
export function getAssessmentBySessionId(sessionId: string): AssessmentData | undefined {
...
export function getAssessmentsByType(assessmentId: string): AssessmentData[] {
  return assessmentData.filter(data => data.assessment_id === assessmentId);
}
